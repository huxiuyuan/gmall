...
public class CategoryController {
    ...
    @ApiOperation("分类查询")
    public ResponseVo<List<CategoryEntity>> selectCategoryById(@PathVariable("parentId") Long pid){
        List<CategoryEntity> categoryEntities = categoryService.selectCategoryByPid(pid);
